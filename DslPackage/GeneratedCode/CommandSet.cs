...
namespace Company.MobileDSL
{
	...
	/// </summary>
	internal partial class MobileDSLCommandSet : MobileDSLCommandSetBase
	{
		/// <summary>
		/// Constructs a new MobileDSLCommandSet.
		/// </summary>
		public MobileDSLCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class MobileDSLCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new MobileDSLCommandSetBase.
		/// </summary>
		protected MobileDSLCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewMobileDSLExplorerCommand,
				typeof(MobileDSLEditorFactory).GUID);
		...
		{
			MobileDSLExplorerToolWindow explorer = this.MobileDSLExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentMobileDSLDocData != null && this.CurrentMobileDSLDocData.Store != null)
			{
				this.CurrentMobileDSLDocData.ValidationController.Validate(this.CurrentMobileDSLDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentMobileDSLDocData != null && this.CurrentMobileDSLDocData.Store != null)
			{
				...
				this.CurrentMobileDSLDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected MobileDSLDocData CurrentMobileDSLDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as MobileDSLDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected MobileDSLDocView CurrentMobileDSLDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as MobileDSLDocView;
			}
		}
		...
		/// </summary>
		protected MobileDSLExplorerToolWindow MobileDSLExplorerToolWindow
		{
			get
			{
				MobileDSLExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(MobileDSLExplorerToolWindow), true) as MobileDSLExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				MobileDSLExplorerToolWindow explorerWindow = this.MobileDSLExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class MobileDSLClipboardCommandSet : MobileDSLClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new MobileDSLClipboardCommandSet.
		/// </summary>
		public MobileDSLClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class MobileDSLClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new MobileDSLClipboardCommandSetBase.
		/// </summary>
		protected MobileDSLClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
