...
namespace Company.MobileDSL
{
	...
	internal abstract partial class MobileDSLDocDataBase : DslShell::ModelingDocData
	{
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			modelRoot = global::Company.MobileDSL.MobileDSLSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
